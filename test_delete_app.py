...
def test_delete_apps():
    button_delete = driver.find_element(By.XPATH, '//*[@id="main_body"]/div/div/main/div/div/div/div[2]/div/div/div[2]/div/table/tbody/tr[2]/td[6]/a[2]').click()
    time.sleep(3)
