...
def test_search_apps():
    field_name_app = driver.find_element(By.XPATH, '//*[@id="main_body"]/div/div/main/div/div/div/div[2]/div/div/div[1]/div[2]/form/div/div[1]/input')
    field_name_app.send_keys("admin")
    time.sleep(1)

    button_search = driver.find_element(By.XPATH, '//*[@id="main_body"]/div/div/main/div/div/div/div[2]/div/div/div[1]/div[2]/form/div/div[2]/input').click()
    time.sleep(3)
