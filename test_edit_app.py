...
def test_edit_apps():
    button_edit = driver.find_element(By.XPATH, '//*[@id="main_body"]/div/div/main/div/div/div/div[2]/div/div/div[2]/div/table/tbody/tr[2]/td[6]/a[1]').click()
    time.sleep(3)

    field_name_app = driver.find_element(By.XPATH, '//*[@id="main_body"]/div/div/main/div/div/div/div[2]/div/div/div/div[2]/form/div/div[2]/input')
    field_name_app.send_keys("Operaciones 2")
    time.sleep(1)

    button_update = driver.find_element(By.XPATH, '//*[@id="main_body"]/div/div/main/div/div/div/div[2]/div/div/div/div[2]/form/div/div[7]/input[1]').click()
    time.sleep(1)
